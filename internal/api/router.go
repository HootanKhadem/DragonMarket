...
func NewRouter(deps Dependencies) *gin.Engine {
	...
	router.POST("/items/:id/purchase", validateItemIDParam(), RequireGuildID(), itemHandlers.Purchase)
	...
	router.POST("/auctions", RequireGuildID(), auctionHandlers.Create)
	router.GET("/auctions", auctionHandlers.List)
	router.GET("/auctions/:id", auctionHandlers.Get)
	router.POST("/items/:id/bid", validateItemIDParam(), RequireGuildID(), auctionHandlers.PlaceBid)
	router.DELETE("/items/:id/bid/:bid_id", validateItemIDParam(), validateBidIDParam(), RequireGuildID(), auctionHandlers.CancelBid)
